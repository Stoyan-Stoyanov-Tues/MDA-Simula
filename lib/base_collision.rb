...
module Base_collision
	...
	def rectangle(object)
		...
		left = self.rectangle_x - self.virtual_model.width/2
		right = self.rectangle_x + self.virtual_model.width/2
		
		top_2 = object.rectangle_y - object.virtual_model.height/2
		bottom_2 = object.rectangle_y + object.virtual_model.height/2
		left_2 = object.rectangle_x - object.virtual_model.width/2
		right_2 = object.rectangle_x + object.virtual_model.width/2
